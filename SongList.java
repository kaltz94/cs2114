...
public class SongList extends DLinkedList<Song> {
	...
	/**
	 * Sorts the songs by title (lexicographically), using insertion sort.
	...
	/**
	 * Sorts the songs by artist (lexicographically), using insertion sort.
	...
	/**
	 * Sorts the songs by release year, using insertion sort.  Songs
	 * released in the same year are sorted by title.  If some songs
	 * have the same year and title, they are sorted by release year.
	 * Songs with the same title, artist, and year are sorted by
	 * genre.
	 */
	 ...
	 * song is less than another if its title is lexicographically
	 * before the other song's, if the titles are equal but the first
	 * song's artist is lexicographically before the other song's, if
	 * the titles and artists are equal but the first song's release
	 * year is lexicographically before the other song's, or if the
	 * titles, artists, and release years are equal but the first
	 * song's genre is lexicographically before the other song's.
	 * 
	 * @param position
	 * @return
	 */
