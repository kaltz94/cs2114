...
public class SurveyWindow
{
    ...
    public SurveyWindow(SongList list, String[][] data)
    {
    ...
    public void clickedPrev(Button button)
    {
        ...
        while (iterator.hasNext() && counter < 9)
        {
            ...
            Song song = list.getEntry(currentIndex);
            if (type.equals(RepresentationType.HOBBY))
            {
                int widthHeRead = song.calcHobbyHeard(currentIndex, dataArray)[0];
              
            }
                //Shape bar1 = new Shape(100 + counter * 10, 100 + counter * 10  )
        }
